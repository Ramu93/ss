	...
	<div class="widget-box widget-box-90">
        ...
        <div class="widget-content nopadding">
			<table id="ticket_list" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php 
                        $select_query = "SELECT a . * , b.item_name, a.item_master_id, d.location_name, a.location_id, e.department_name, a.department_id, f.engineer_name,g.item_name, a.item_master_id FROM raise_ticket a, item_master b, party_location d, department e, engineer f, item_master g WHERE a.ticket_id = b.item_master_id AND a.ticket_id = d.party_location_id AND a.ticket_id = e.department_id AND a.ticket_id = f.engineer_id AND a.ticket_id =g.item_master_id ORDER BY a.ticket_id ASC";
